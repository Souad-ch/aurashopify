    ...
    <>
      ...
      <section className="bg-gradient-to-b from-brand-50 to-white py-16">
        <div className="mx-auto max-w-3xl px-4 text-center sm:px-6">
          <h1 className="text-4xl font-extrabold text-ink sm:text-5xl">أسعار بسيطة وشفافة</h1>
          <p className="mt-4 text-lg text-ink-soft">اختر الخطة التي تناسب حجم أعمالك. بدون رسوم خفية.</p>
        </div>
      </section>
      ...
      <section className="bg-gray-50 py-20">
        <div className="mx-auto max-w-3xl px-4 sm:px-6">
          <h2 className="text-center text-3xl font-extrabold text-ink">أسئلة شائعة</h2>
